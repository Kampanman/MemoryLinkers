...
<head>
  ...
  <title><?= '注目の'.$theme.'『GoodTube』一覧';?></title>
...
<div class="container" align="center">
    <a data-id="thisFile" href="../bookAdmin/bookAdmin.php" style="text-decoration: none;"><button class="btn btn-danger btn-block">ググり本管理ページへ</button></a>
    <br>
    ...
    <br>
    <a data-id="thisFile" href="youtubeAdmin.php" style="text-decoration: none;"><button class="btn btn-primary btn-block">GoodTube管理ページへ</button></a>
</div>
    <div class="container" style="">
        <h3 align="center"><?= '『GoodTube』一覧';?></h3>
