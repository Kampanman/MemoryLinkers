...
<div class="container" align="center">
    <a data-id="thisFile" href="bookAdmin.php" style="text-decoration: none;"><button class="btn btn-danger btn-block">ググり本管理ページへ</button></a>
    <br>
    ...
    <div class="container" style="">
        <h3 align="center"><?= '読んできた『'.$theme.'』一覧';?></h3>
